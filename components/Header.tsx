...
export default function Header({ scrollHandler }) {
  return (
    <header className="relative">
      <Link
          className="flex items-center justify-center rounded-md border border-transparent bg-white px-4 py-3 text-base font-medium text-orange-600 shadow-sm hover:bg-orange-100 sm:px-8 absolute top-0 right-0 z-10 m-5"
          href='/recipes/new'
      >
        + Add recipe
      </Link>
        ...
        <div className="relative shadow-xl sm:overflow-hidden">
          ...
          <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8">
            ...
            <h1 className="mt-1 text-center font-bold uppercase text-gray-900 sm:text-5xl sm:tracking-tight lg:text-7xl">
              ...
              <span className="block text-orange-500">food</span>
            </h1>
